...
export const insertUserInformationSchema = createInsertSchema(userInformations).omit({ timestamp: true });
export const onlyNecessaryUserInformationSchema = createInsertSchema(userInformations).pick({ user: true, information: true, guild: true });
